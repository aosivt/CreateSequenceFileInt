...
public final class ImageGrayScale_int
{
    ...
    static {
        ...
        metadata.putInt(1);
        metadata.putInt(1);
///в зависимости от последнего значение преобразуется отображение тиф файла
// в соответствии если 0 - то 0 это белый, если 1 - то 0 это черный
...
////
    ...
    public final static void aoswriteImage(int w, int h
            //, float[] pixels
